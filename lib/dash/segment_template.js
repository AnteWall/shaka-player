...
shaka.dash.SegmentTemplate = class {
  ...
  static createStreamInfo(
    ...
    const scaledPresentationTimeOffset = info.scaledPresentationTimeOffset;
      ...
      return {
        generateSegmentIndex: () => {
          return SegmentTemplate.generateSegmentIndexFromDuration_(
              shallowCopyOfContext, info, segmentLimit);
        },
        initSegmentReference,
        scaledPresentationTimeOffset,
      };
   ...
   * @private
   */
  static generateSegmentIndexFromDuration_(context, info, segmentLimit) {
      ...
      const createUris =
          () => {
            ...
            const mediaUri = MpdUtils.fillUriTemplate(
                ...
                segmentReplacement, bandwidth, timeReplacement);
